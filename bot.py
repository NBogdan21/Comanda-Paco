...
# ── Config ────────────────────────────────────────────────────────────────────
# Railway: add DISCORD_TOKEN in your project's Variables tab.
# Local:   create a .env file with  DISCORD_TOKEN=your_token_here
try:
...
TOKEN = os.environ["DISCORD_TOKEN"]          # clear crash if missing
PORT  = int(os.environ.get("PORT", 8080))    # Railway injects PORT automatically
ORDERS_FILE = "/data/orders.json"            # mounted volume → survives redeploys
...
# ── Keep-alive web server (Railway health checks) ─────────────────────────────
